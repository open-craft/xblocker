...
SECRET_KEY = os.environ.get('XBLOCKER_SECRET_KEY', 'insecure-secret-key')
...
ROOT_URLCONF = 'xblocker.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'xblocker.wsgi.application'
...
SESSION_COOKIE_NAME = 'xblocker_sessionid'
CSRF_COOKIE_NAME = 'xblocker_csrftoken'
LANGUAGE_COOKIE_NAME = 'xblocker_language'
