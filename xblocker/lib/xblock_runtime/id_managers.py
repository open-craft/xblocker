...
class OpaqueKeyReader(IdReader):
    ...
    def get_definition_id(self, usage_id):
        ...
        if isinstance(usage_id, BlockUsageLocator):
            ...
            raise NotImplementedError("This runtime does not support getting a definition_id from a BlockUsageLocator.")
            # The following code could give us the answer, but eww.
